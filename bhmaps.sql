...
--
-- Host: 127.0.0.1
-- Generation Time: 27-Jan-2018 às 20:52
...
(1, 'TEste', 'Teste', 9, 17, '-19.665866618043186,-43.971405029296875', 'Confins, MG, 33500-000, Brasil', '2018-01-27 18:49:43', '2018-01-27 18:49:43'),
(2, 'teste', 'teste', 13, 17, '-20.023677645296186,-44.243316650390625', 'Betim, MG, Brasil', '2018-01-27 19:18:04', '2018-01-27 19:18:04');

-- --------------------------------------------------------

--
-- Estrutura da tabela `marker_theme`
--

CREATE TABLE `marker_theme` (
  `id` int(11) NOT NULL,
  `name` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Extraindo dados da tabela `marker_theme`
--

INSERT INTO `marker_theme` (`id`, `name`) VALUES
(1, 'Rodovias e vias urbanas'),
(2, 'Transporte de cargas'),
(3, 'Ocupação do entorno'),
(4, 'Sustentabilidade e Meio Ambiente'),
(5, 'Transporte a pé e bicicleta'),
(6, 'Transporte Coletivo'),
(7, 'Prevenção de acidentes'),
(8, 'Acessibilidade Universal');
...
INSERT INTO `marker_type` (`id`, `title`, `color`, `theme_id`) VALUES
(9, 'Melhorias da via', '1', 1),
(10, 'Sinalização e semáforos', '2', 1),
(11, 'Congestionamentos', '3', 1),
(12, 'Mudanças na circulação', '4', 1),
(13, 'Carga e descarga', '5', 2),
(14, 'Restrição de circulação', '6', 2),
(15, 'Rota preferencial', '7', 2),
(16, 'Depósitos, centros de distribuição, etc', '8', 2),
(17, 'Uso incompatível com a via', '9', 3),
(18, 'Área sem atendimento', '10', 3),
(19, 'Região subaproveitada', '11', 3),
(20, 'Poluição atmosférica e/ou sonora', '12', 4),
(21, 'Proteção de rios e nascentes', '13', 4),
(22, 'Conflito com a fauna e flora', '14', 4),
(23, 'Calçada e/ou travessia de pedestre', '15', 5),
(24, 'Uso de bicicletas, ciclovia e afins', '16', 5),
(25, 'Terminais, Estações, Pontos', '17', 6),
(26, 'Itinerários e quadro de horário', '18', 6),
(27, 'Operação e fiscalização', '19', 6),
(28, 'Acidentes constantes', '20', 7),
(29, 'Risco de acidentes graves', '21', 7),
(30, 'Atropelamentos', '22', 7),
(31, 'Rampas de calçadas', '23', 8),
(32, 'Dificuldade de circulação', '24', 8),
(33, 'Região inacessível', '25', 8);
...
--
-- Indexes for table `marker_theme`
--
ALTER TABLE `marker_theme`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `marker_theme`
--
ALTER TABLE `marker_theme`
